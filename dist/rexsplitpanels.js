  ...
  var SplitPanels = /*#__PURE__*/function (_Sizer) {
    ...
    function SplitPanels(scene, config) {
      ...
      _this.add(firstChild, {
        ...
        expand: true,
        padding: {
          left: GetValue(spaceConfig, "".concat(firstChildKey, "Left"), 0),
          right: GetValue(spaceConfig, "".concat(firstChildKey, "Right"), 0),
          top: GetValue(spaceConfig, "".concat(firstChildKey, "Top"), 0),
          bottom: GetValue(spaceConfig, "".concat(firstChildKey, "Bottom"), 0)
        }
      });
      _this.add(splitter, {
        proportion: 0,
      ...
      _this.add(secondChild, {
        ...
        expand: true,
        padding: {
          left: GetValue(spaceConfig, "".concat(secondChildKey, "Left"), 0),
          right: GetValue(spaceConfig, "".concat(secondChildKey, "Right"), 0),
          top: GetValue(spaceConfig, "".concat(secondChildKey, "Top"), 0),
          bottom: GetValue(spaceConfig, "".concat(secondChildKey, "Bottom"), 0)
        }
      });
      ...
      _this.minFirstChildSize = GetValue(config, minFirstChildSizeKey, 0);
      _this.minSecondChildSize = GetValue(config, minSecondChildSizeKey, 0);
      _this.setSplitRatio(GetValue(config, 'splitRatio', 0.5));
